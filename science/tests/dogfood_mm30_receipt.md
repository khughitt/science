...
Date: 2026-04-21
Worktree: `/mnt/ssd/Dropbox/science/.worktrees/verdict-parse-rollup-mvp/science`
...
```bash
uv run science verdict parse <doc> --registry /mnt/ssd/Dropbox/r/mm30/specs/claim-registry.yaml
```
...
```bash
uv run science verdict rollup --scope claim --root /mnt/ssd/Dropbox/r/mm30/doc/interpretations --registry /mnt/ssd/Dropbox/r/mm30/specs/claim-registry.yaml --output json
```
...
```bash
uv run science verdict rollup --scope claim --root /mnt/ssd/Dropbox/r/mm30/doc/interpretations --registry /mnt/ssd/Dropbox/r/mm30/specs/claim-registry.yaml --output json > /tmp/mm30_scope_claim.json
uv run science verdict rollup --by-claim --root /mnt/ssd/Dropbox/r/mm30/doc/interpretations --registry /mnt/ssd/Dropbox/r/mm30/specs/claim-registry.yaml --output json > /tmp/mm30_by_claim.json
...
```bash
uv run science verdict rollup --scope claim --strict --root /mnt/ssd/Dropbox/r/mm30/doc/interpretations --registry /mnt/ssd/Dropbox/r/mm30/specs/claim-registry.yaml --output json
```
...
```bash
uv run science verdict rollup --scope all --root /mnt/ssd/Dropbox/r/mm30/doc/interpretations --output table
```
