...
def test_method_resolves_to_method_entity() -> None:
    ...
    assert registry.resolve_class("method") is MethodEntity


def test_workflow_step_resolves_to_workflow_step_entity() -> None:
    registry = EntityRegistry.with_core_types()
    assert registry.resolve_class("workflow-step") is WorkflowStepEntity
...
def test_workflow_still_resolves_to_project_entity() -> None:
    ...
    registry = EntityRegistry.with_core_types()
    assert registry.resolve_class("workflow") is ProjectEntity
