...
def test_belief_snapshot_writes_jsonl(tmp_path: Path, monkeypatch):
    ...
    canned = [
        {
            ...
            "contested": False,
            "diagnostic_dispute_count": 0,
            "scalar_enabled": False,
            "massed_support_score": None,
            "massed_dispute_score": None,
            "massed_support_band": None,
            "massed_dispute_band": None,
            "net_band": None,
            "net_robust": None,
            "input_hashes": ["sha256:abc"],
            "config_version": "belief-logodds-v3",
    ...
    result = runner.invoke(
        cli.main,
        ["belief", "snapshot", "--path", str(tmp_path / "knowledge" / "graph.trig"), "--as-of", "2026-05-24"],
    )
