...
def test_canonical_runs_against_minimal_project(tmp_path: Path, monkeypatch: "object") -> None:
    ...
    required-directory checks; we exit with science absent by setting
    SCIENCE_VALIDATE_SKIP_DOTENV=1 (no .env probe) and pre-resolving via
    SCIENCE_TOOL_PATH pointing at this repo's science.
    """
    ...
    env = {
        ...
        "HOME": str(tmp_path),
        "SCIENCE_TOOL_PATH": str(repo_root / "science"),
