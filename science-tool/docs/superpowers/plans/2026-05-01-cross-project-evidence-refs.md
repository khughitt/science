...
|---|---|---|
| `science-tool/tests/test_graph_materialize.py` | Modify | Regression tests for `source_refs` strictness and `evidence_refs` graph output |
| `science-model/src/science_model/entities.py` | Modify | Add `evidence_refs` to the shared entity schema |
| `science-tool/src/science_tool/graph/sources.py` | Modify | Normalize `evidence_refs` from markdown frontmatter into entity raw records |
| `science-tool/src/science_tool/graph/migrate.py` | Modify | Audit `evidence_refs`, allowing cross-project addresses while preserving local unresolved failures |
| `science-tool/src/science_tool/graph/materialize.py` | Modify | Emit provenance edges for local/external/cross-project evidence refs |
| `science-tool/docs/superpowers/specs/2026-05-01-cross-project-evidence-refs-design.md` | Read | Source design |
...
```bash
git add science-model/src/science_model/entities.py science-tool/src/science_tool/graph/materialize.py science-tool/src/science_tool/graph/migrate.py science-tool/src/science_tool/graph/sources.py science-tool/tests/test_graph_materialize.py science-tool/docs/superpowers/plans/2026-05-01-cross-project-evidence-refs.md
