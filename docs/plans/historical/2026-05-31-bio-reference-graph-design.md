...
Related:
- `docs/plans/historical/2026-05-26-bio-data-architecture-umbrella-design.md` — umbrella; RG1 partly addresses its non-tabular-reference open item
...
- `docs/plans/historical/2026-05-26-bio-identity-and-reference-genome-design.md` — Pillar C; molecular identity context and later transcript/protein projection
