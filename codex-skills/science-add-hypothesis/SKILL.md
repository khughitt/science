...
4. Read `.ai/templates/hypothesis.md` first; if not found, read `templates/hypothesis.md`. Use hypothesis templates only after creation, as body-writing references.
