...
3. For `Core now` items, create a **stub-only** note at `entities/papers/<citekey>.md` using `.ai/templates/paper.md` first, then `templates/paper.md`. The stub must contain:
