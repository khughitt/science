...
6. **Prior/likelihood sensitivity.** Power-scale the prior and the likelihood
   ...
   [`sensitivity-arbitration.md`](../study-design/sensitivity-arbitration.md).
...
- [`sensitivity-arbitration.md`](../study-design/sensitivity-arbitration.md) — the power-scaling prior-sensitivity step and how it arbitrates the verdict.
