---
name: genomics-copy-number-sv-qa
...
- [`../../study-design/power-floor-acknowledgement.md`](../../study-design/power-floor-acknowledgement.md) — focal-event and per-cell contrasts are typically low-power.
- [`../../study-design/sensitivity-arbitration.md`](../../study-design/sensitivity-arbitration.md) — ploidy-model and AA/AC-version variants are the canonical sensitivity pair.
