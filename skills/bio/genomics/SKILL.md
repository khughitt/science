...
- [`../expression/SKILL.md`](../transcriptomics/SKILL.md) — expression cohorts often paired with mutation cohorts.
- [`../../statistics/power-floor-acknowledgement.md`](../../study-design/power-floor-acknowledgement.md) — mutation-frequency contrasts are typically low-power for rare genes.
- [`../../statistics/sensitivity-arbitration.md`](../../study-design/sensitivity-arbitration.md) — hypermutator-included vs -excluded analyses are the canonical sensitivity pair.
