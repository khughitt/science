...
- [`../data-management/conventions.md`](../data-management/conventions.md) — input-data conventions; pipelines should read from `data/raw/` and write to `data/processed/` or `results/`.
