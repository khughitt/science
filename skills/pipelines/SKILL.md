...
- [`../data/SKILL.md`](../data-management/SKILL.md) — input-data conventions; pipelines should read from `data/raw/` and write to `data/processed/` or `results/`.
- [`../research/research-package-spec.md`](../research-package/research-package-spec.md) — terminal rule should produce a research package.
