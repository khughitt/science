...
Historical design context lives at `references/docs/plans/historical/2026-04-21-project-curation-design.md`.
...
- `markers_missing` → propose inserting the `BEGIN: load-bearing-constraints`
  ...
  in `references/templates/agents-md.md`) along with a freshly drafted digest. This
