...
Use the canonical scaffold at `references/templates/agents-md.md` as the
...
`references/templates/core-overview.md` and
`references/templates/core-decisions.md`. Skip if the user declines.
...
Framework defaults are resolved centrally from the Science toolkit.
