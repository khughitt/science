...
2. Read `references/docs/user-guide/evidence-lines.md`.
3. Read `.ai/templates/interpretation.md` first; if not found, read `references/templates/interpretation.md`.
...
- **Dev mode:** the result is about tooling or workflow rather than substantive empirical evidence. Use the dedicated `references/templates/interpretation-dev.md` (see Writing below) — the empirical-mode sections are dead weight for infrastructure work.
...
- **Dev mode:** follow `.ai/templates/interpretation-dev.md` first, then `references/templates/interpretation-dev.md`. Skip the empirical sections (Evidence Quality, Data Quality Checks, Proposition-Level Updates, Evidence vs. Open Questions) entirely — the dev template omits them on purpose.
- **All other modes (write / update / conceptual):** follow `.ai/templates/interpretation.md` first, then `references/templates/interpretation.md`.
...
6. Suggest next steps:
   - `science-compare-hypotheses` skill
   - `science-discuss` skill
   - `science-add-hypothesis` skill
...
assumption turned out to be violated, consider `science-post-mortem` skill to capture
