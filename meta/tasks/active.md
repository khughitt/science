...
## [t042] Cross-project blockers spec
- priority: P1
- status: deferred
...
## [t043] Workspace registry design
- priority: P2
- status: deferred
- group: project-peers
- created: 2026-05-07
...
## [t044] Remote peers via cloneable repos
- priority: P3
- status: deferred
- group: project-peers
- created: 2026-05-07
...
## [t045] Versioned entity references
- priority: P3
- status: deferred
- group: project-peers
- created: 2026-05-07
...
## [t047] Composite graph policy controls (compose: opt-in)
- priority: P2
- status: deferred
- group: project-peers
- created: 2026-05-07
...
## [t048] Service / capability exchange (Layer 3)
- priority: P2
- status: deferred
- group: project-peers
- created: 2026-05-07
...
## [t049] Multi-user identity scoping
- priority: P3
- status: deferred
- group: project-peers
- created: 2026-05-07
...
## [t050] Auto-unblock / change notification
- priority: P3
- status: deferred
- group: project-peers
- created: 2026-05-07
...
## [t051] Symmetry tooling (peers check --symmetric)
- priority: P3
- status: deferred
- aspects: [software-development]
- group: project-peers
