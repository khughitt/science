...
Design complete: doc/plans/2026-05-06-t034-causal-graph-extension-design.md + production validator src/t034_validator/ wired into validate_local.py and enforced by ./validate.sh. Residual mechanical items (per-extension consumer rules, multi-extension dispatch) can spin into a focused follow-up if needed.
