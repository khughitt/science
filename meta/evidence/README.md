...
See `doc/plans/2026-05-06-t034-causal-graph-extension-design.md` for the
authoritative rule set, and the three slice prototypes in `doc/plans/` for
worked test fixtures.
