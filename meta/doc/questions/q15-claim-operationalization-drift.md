---
id: question:15-claim-operationalization-drift
type: question
title: How should Science detect and prevent epistemic drift between an entity's claims and its operationalization?
status: active
ontology_terms: []
datasets: []
source_refs: []
...
- Related questions: `question:14-adaptive-project-topology` (topology adaptation to
  evidence/uncertainty/decay — this question is the drift-detection half of that), and
  `question:04-authoring-cost-audit` (the `operationalized_by:` contract and agentic review both
