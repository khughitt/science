---
id: question:06-sequential-anytime-valid-evidence
type: question
title: Should Science treat evidence accumulation as sequential and anytime-valid rather than fixed-N synthesis?
status: active
ontology_terms: []
datasets: []
source_refs:
...
- Related hypotheses: `hypothesis:h01-stochastic-revisiting`, `hypothesis:h03-reason-coded-revisiting-beats-posterior-only-revisiting`, `hypothesis:h05-sequential-evidence-improves-attention`.
