...
type: question
title: How should Science model LLM agents as fallible evidence sources and graph-governed operators?
status: active
ontology_terms: []
datasets: []
source_refs:
...
- Related questions: `question:03-source-and-pipeline-provenance`, `question:05-source-dependence-detection`, `question:12-agent-tool-kg-operations`.
