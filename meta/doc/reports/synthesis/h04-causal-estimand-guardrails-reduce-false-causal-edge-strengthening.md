...
**Key open questions:** `question:02-causal-synthesis-guardrails` (when synthesized evidence may strengthen causal propositions), `question:10-causal-graph-construction-pipeline`, and `question:11-graph-valued-synthesis-artifacts` remain unresolved. No audit of existing artifacts for estimand metadata coverage has been conducted.
