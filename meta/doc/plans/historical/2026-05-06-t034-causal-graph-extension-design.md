...
>
> **v1 (prior, superseded):** Designs the `[t034]` aspect extension(s) against the v2.2 evidence-payload contract at `meta/doc/plans/historical/2026-05-06-evidence-payload-core-and-extension-contract.md`. Drafted bottom-up from the seven Batch 3 paper-summary specifics most load-bearing for extension design.
>
...
Two cross-cutting conventions govern how this document's per-extension `Reason-code contributions` sections are read. They were tacit through v1.2 and made explicit in v1.3 after the second validator-prototype slice (`meta/doc/plans/historical/2026-05-06-t034-mr-graph-model-validator-findings.md`) needed unambiguous semantics.
