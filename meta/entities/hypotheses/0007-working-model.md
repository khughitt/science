...
`interpretation:0002-l1-patch-prototype-2026-06-01`; machinery `science_tool.model`,
...
`interpretation:0003-t066-latent-correction-2026-06-01`, code
...
`interpretation:0004-t067-patch-federation-2026-06-01`, code
...
own namespace — e.g. meta's `question:0014` is "adaptive-project-topology", unrelated):
