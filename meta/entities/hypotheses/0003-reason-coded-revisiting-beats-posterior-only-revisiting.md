...
- `hypothesis:0001-stochastic-revisiting` is the parent attention hypothesis.
- `hypothesis:0002-rich-evidence-payloads-improve-graph-calibration` supplies the payload fields needed to derive reason codes.
- `question:0002-evidence-payload-schema`, `question:0004-source-and-pipeline-provenance`, `question:0010-causal-graph-construction-pipeline`, `question:0011-graph-valued-synthesis-artifacts`, `question:0012-agent-tool-kg-operations`, and `question:0013-robustness-reproducibility-evaluation` define the representation problem.
