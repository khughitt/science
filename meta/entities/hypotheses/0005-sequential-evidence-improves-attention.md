...
- `question:0007-sequential-anytime-valid-evidence` is the direct design question.
- `hypothesis:0001-stochastic-revisiting` and `hypothesis:0003-reason-coded-revisiting-beats-posterior-only-revisiting` define the attention layer that H05 modifies.
- `hypothesis:0002-rich-evidence-payloads-improve-graph-calibration` defines the payload layer that H05 reuses.
