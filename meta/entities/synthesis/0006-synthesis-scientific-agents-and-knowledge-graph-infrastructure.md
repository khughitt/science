...
created: '2026-05-06'
updated: '2026-05-06'
id: synthesis:0006-synthesis-scientific-agents-and-knowledge-graph-infrastructure
...
Batch 5 directly updates `question:0008-llm-agents-as-fallible-sources`.
...
- `question:0012-agent-tool-kg-operations` asks how Science represents agent operations, tool graphs, KG transformations, and graph evolution events.
