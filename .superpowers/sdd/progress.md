...
- [x] Task 4: promote_dataset.py
- [x] Task 5: prompt_resolve -> cli.py (evicts click)
- [x] Task 6: guard (test_commons_domain_purity.py)
...
Task 4: complete (promote_dataset.py 547 lines, promote.py 2760->2251, 8017 passed)
Task 5: complete (click evicted; promote.py 2251->2193; cli.py sole click importer; 8018 passed)
Task 6: complete (guard landed; 12/12 injections proven to bite; 8073 passed)
